...
- [ ] Confirm Azure subscription available
- [ ] Confirm Microsoft Foundry/Azure OpenAI model deployment access in the intended region
- [ ] Confirm GitHub repository location and account
